...
// The definition data itself lives in @sim/core's scenario registry
// (LC500_GOOD + the named presets); this module names it as the
// package's own and carries the package metadata.
import { LC500_GOOD, type InstrumentDefinition } from '@sim/core/instrument'
import { SCENARIOS, getScenario, type Scenario } from '@sim/core/scenario'
